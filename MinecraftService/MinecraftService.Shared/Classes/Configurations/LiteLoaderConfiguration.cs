...
namespace MinecraftService.Shared.Classes.Configurations {
    public class LiteLoaderConfiguration : ServerInfo, IServerConfiguration {
        ...
        public LiteLoaderConfiguration(IProcessInfo processInfo, IServerLogger logger, ServiceConfigurator serviceConfiguration) : base() {
        ...
        public MinecraftServerArch GetServerArch() => ServerArch;
