...
namespace MinecraftService.Service.Server.ConsoleFilters
{
    public class BedrockPlayerConnectedFilter : IConsoleFilter {
        ...
        public BedrockPlayerConnectedFilter(MmsLogger logger, UserConfigManager configurator, IServerConfiguration serverConfiguration, IServerController bedrockServer, ServiceConfigurator mineraftService) {
