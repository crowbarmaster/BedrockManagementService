...
namespace MinecraftService.Service.Server.ConsoleFilters {
    public class ServerRescErrorFilter : IConsoleFilter {
        ...
        public ServerRescErrorFilter(IServerLogger logger, IConfigurator configurator, IServerConfiguration serverConfiguration, IServerController bedrockServer, ServiceConfigurator mineraftService) {
