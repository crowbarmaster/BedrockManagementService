...
namespace MinecraftService.Service.Server.ConsoleFilters {
    public class BedrockVersionFilter : IConsoleFilter {
        ...
        public BedrockVersionFilter(IServerLogger logger, IConfigurator configurator, IServerConfiguration serverConfiguration, IServerController bedrockServer, ServiceConfigurator mineraftService) {
