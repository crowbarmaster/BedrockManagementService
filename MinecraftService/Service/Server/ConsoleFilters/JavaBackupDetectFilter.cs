...
namespace MinecraftService.Service.Server.ConsoleFilters {
    public class JavaBackupDetectFilter : IConsoleFilter {
        ...
        public JavaBackupDetectFilter(IServerLogger logger, IConfigurator configurator, IServerConfiguration serverConfiguration, IServerController javaServer, ServiceConfigurator mineraftService) {
