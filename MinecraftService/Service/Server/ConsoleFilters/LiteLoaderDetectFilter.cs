...
namespace MinecraftService.Service.Server.ConsoleFilters {
    public class LiteLoaderDetectFilter : IConsoleFilter {
        ...
        public LiteLoaderDetectFilter(IServerLogger logger, IConfigurator configurator, IServerConfiguration serverConfiguration, IServerController bedrockServer, IServiceConfiguration mineraftService) {
