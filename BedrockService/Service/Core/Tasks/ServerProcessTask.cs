...
{
    class ServerProcessTask : IServiceTask
    {
        private Task _thread;
        private CancellationTokenSource _cancellationTokenSource = new CancellationTokenSource();
        public ServerProcessTask(Action<CancellationToken> method) => _thread = Task.Factory.StartNew((CancellationToken) => method(_cancellationTokenSource.Token), _cancellationTokenSource.Token);
