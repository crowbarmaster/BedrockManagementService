...
namespace BedrockService.Service.Core.Tasks
{
    class HeartbeatTask : IServiceTask
    {
        ...
        public HeartbeatTask(Action<CancellationToken> method) => _thread = Task.Factory.StartNew((CancellationToken) => method(_cancellationTokenSource.Token), _cancellationTokenSource.Token);
