...
namespace BedrockService.Service.Server.ConsoleFilters {
    public class PlayerDisconnectedFilter : IConsoleFilter {
        ...
        public PlayerDisconnectedFilter(IBedrockLogger logger, IConfigurator configurator, IServerConfiguration serverConfiguration, IBedrockServer bedrockServer, IServiceConfiguration bedrockService) {
