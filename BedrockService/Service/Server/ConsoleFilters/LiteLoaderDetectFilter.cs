...
namespace BedrockService.Service.Server.ConsoleFilters {
    public class LiteLoaderDetectFilter : IConsoleFilter {
        ...
        public LiteLoaderDetectFilter(IBedrockLogger logger, IConfigurator configurator, IServerConfiguration serverConfiguration, IBedrockServer bedrockServer, IServiceConfiguration bedrockService) {
