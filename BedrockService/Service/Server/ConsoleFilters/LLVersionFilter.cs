...
namespace BedrockService.Service.Server.ConsoleFilters {
    public class LLVersionFilter : IConsoleFilter {
        ...
        public LLVersionFilter(IServerLogger logger, IConfigurator configurator, IServerConfiguration serverConfiguration, IServerController bedrockServer, IServiceConfiguration bedrockService) {
