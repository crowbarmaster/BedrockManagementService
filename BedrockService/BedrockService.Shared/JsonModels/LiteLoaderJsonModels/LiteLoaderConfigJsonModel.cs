...
namespace MinecraftService.Shared.JsonModels.LiteLoaderJsonModels {
    ...
    public class DisableAutoCompactionLog {
        public bool enabled { get; set; }
    }
    ...
    public class ResourcePackEncryption {
    ...
    public class Modules {
        ...
        public DisableAutoCompactionLog DisableAutoCompactionLog { get; set; }
        ...
        public FixBroadcastBug FixBroadcastBug { get; set; }
    ...
    public class LiteLoaderConfigJsonModel {
        ...
        public ResourcePackEncryption ResourcePackEncryption { get; set; }
