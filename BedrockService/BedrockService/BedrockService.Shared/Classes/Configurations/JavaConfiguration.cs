...
namespace BedrockService.Shared.Classes.Configurations
{
    public class JavaConfiguration : ServerInfo, IServerConfiguration
    {
        ...
        public bool InitializeDefaults()
        {
            ...
            ServicePropList.Add(new Property(ServerPropertyStrings[ServerPropertyKeys.ServerExeName], $"BedrockService.Java Server.jar"));
        ...
        public void UpdateServerProps(string version)
        {
            ...
            _defaultPropList = MinecraftFileUtilities.GetDefaultPropListFromFile(GetServiceFilePath(BmsFileNameKeys.BedrockStockProps_Ver, version));
